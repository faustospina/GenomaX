...
public class StatServiceImpl implements StatService{
    ...
    public int getNumMutant() throws GenomeBusinessException {
        return Optional.ofNullable(statRepository.ValueMutant()).orElseThrow(()->new GenomeBusinessException(NotificationCode.EMPTY_DATA));
    }

    @Override
    public int getNumHuman() throws GenomeBusinessException {
        return Optional.ofNullable(statRepository.ValueHuman()).orElseThrow(()->new GenomeBusinessException(NotificationCode.EMPTY_DATA));
    }
}
